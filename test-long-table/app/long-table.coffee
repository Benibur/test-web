...
## PRIVATE SECTION ##
    ...
    _DOM_controlerInit: () ->
        ...
        ###*
         * [_removeRows description]
         * @param  {[type]} fromRank  [description]
         * @param  {[type]} nToRemove [description]
        ...
        _removeRow = (fromRank) ->
            ...
            # case 2 : The deletion is into the buffer
                ...
                ##
                # case 2.1 : The deletion is into the buffer but before
                # the viewport
                if fromRank < viewport_startRk
                    # remove margin of the first element of the buffer
                    buffer.first.el.style.topMargin = 0
